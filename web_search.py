...
if len(terms) > 0:
    ...
    #  Recuperation des documents du corpus, de la matrice tf-idf et du vocabulaire a partir du fichier pickle
...
""".format(nbr=ndoc, val=search_term, items=items, resultat=resultat)
